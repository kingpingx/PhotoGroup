...

{
...

    {
        ...
        // Trimming must not eat a root. On Windows "D:" means the drive's current directory rather
        // than its root, so the separator has to stay; on Unix the root is the separator itself and
        // trimming would leave an empty string.
